...
const parallaxSpeeds = [0.08, -0.05, 0.1];
      ...
      <Reveal className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            <Parallax key={t.company} speed={parallaxSpeeds[i % parallaxSpeeds.length]} className="h-full">
            <div data-reveal-card className="h-full">
            <SpotlightCard
